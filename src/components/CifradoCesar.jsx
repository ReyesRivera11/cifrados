...
function CifradoCesar() {
    ...
    return (
        <div className=" m-auto bg-white shadow-lg p-2 rounded-md max-w-3xl ">
            <ToastContainer />
            <div className="max-w-xl m-auto  rounded-lg">
                ...
                <div className="flex justify-between gap-4">
                    <button
                        className="border-2 w-full border-blue-900 px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-200 hover:text-white font-bold"
                    ...
                    <button
                        ...
                        className="border-2 w-full border-green-900 px-4 py-2 rounded-lg hover:bg-green-700 transition duration-200 cursor-pointer font-bold hover:text-white"
                    >
                        Descifrar
                    </button>
                </div>
