...
function CifradoEscitala() {
    ...
    return (
        <div className="container mx-auto p-6 bg-white shadow-lg  rounded-md">
            <ToastContainer />
            <h2 className="text-4xl font-bold mb-6 text-center text-gray-800">Cifrado Escítala</h2>
            <div className="flex flex-col md:flex-row gap-6">
                <div className="bg-gray-50 w-full p-4 rounded-lg shadow-sm">
                    ...
                    <div className="flex justify-between gap-4 font-bold">
                        <button
                            ...
                            className="border-2 w-full border-blue-900 px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-200"
                        >
                            Cifrar
                        </button>
                        <button
                            onClick={manejarDescifrado}
                            className="border-2 w-full border-green-900 px-4 py-2 rounded-lg hover:bg-green-700 transition duration-200 cursor-pointer"
                            disabled={!mensaje}
                        >
                            Descifrar
                        </button>
                ...
                <div className="flex w-full flex-col items-center bg-gray-50 p-4 rounded-lg shadow-sm">
                            ...
                            <tbody>
                                {matriz.map((fila, i) => (
                                    <tr key={i} className='flex justify-center items-center text-center gap-4 p-2'>
                                        {fila.map((columna, j) => (
                                            <td key={j} className="border-2 h-12 w-12 border-gray-500 px-4 py-2 text-center flex justify-center items-center font-semibold rounded-md">
                                                {columna || ' '}
                                            </td>
                                        ))}
                                    </tr>
